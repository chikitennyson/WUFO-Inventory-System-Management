      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <div class="mb-0 site-logo"><a href="index.html" class="mb-0">WUFO<span class="text-primary">.</span> </a></div>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="#features-section" class="nav-link">Benefits</a>
                  <ul class="dropdown">
    ...
    <div class="site-section hero" id="home-section">
      <div class="container text-center">
        <div class="row justify-content-center text-center">
          <div class="col-lg-10">
            <div class="mb-5">
              <h1 class="hero-heading">Stay Stocked for Success with <strong>WUFO</strong></h1>
              <p>Manage your inventory in real-time, so you always know whats's
              coming in and what's going out.</p>
              <a href="#pricing-section" class="btn btn-primary">Try it for free</a>
            </div>
            <img src="images/screen.png" alt="image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <span class="subtitle-1">Benefits</span>
            <h2 class="section-title-1 font-weight-bold">The Benefits</h2>
          </div>
        </div>
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-5 mr-auto">
            <div class="mb-4">
              <h2 class="section-title-2">View your quantities on hand</h2>
              <p>As stock comes in and out, WUFO
              inventory system management software
         	 auto-updates your inventory. This makes it
      		easy to see what's selling and what to reorder</p>
            </div>
            ...
            <div class="d-flex feature-v1">
              ...
              <div>
                <h3>Organized</h3>
                <p>Organize your product with images,categories, and prices.</p>
              </div>
            </div>
            ...
            <div class="d-flex feature-v1">
              ...
              <div>
                <h3>Calculated</h3>
                <p>Auto-calculate the cost of each product sold using (FIFO).</p>
              </div>
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 order-lg-1 ml-auto">
            <div class="mb-4">
              <h2 class="section-title-2">Stay on top orders</h2>
              <p>Keep track of what you have ordered from
              each vendor. Organise vendor contact info
          in one place to make reordering easy.</p>
            </div>
            ...
            <div class="d-flex feature-v1">
              ...
              <div>
                <h3>Many Features</h3>
                <p>As the value of your changes, so does your balance sheet.</p>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 pricing">
            <div class="border p-5 text-center rounded">
              <h3>Free Access</h3>
              <div class="price mb-3"><sup class="currency">$</sup><span class="number">FREE DEMO</span> <span class="per"></span></div>
              <p class="text-muted mb-4">* Limited features only</p>
              <ul class="list-unstyled ul-check text-left success mb-5">
                ...
                <li>Reports</li>
                <li>Company</li>
                <li class="text-muted"><del>Groups</del></li>
                <li class="text-muted"><del>Users</del></li>
              </ul>
              <p><a href="dash.php" class="btn btn-lg btn-primary rounded-0 btn-block">Free Demo</a></p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 pricing">
            <div class="border p-5 text-center rounded">
              <h3>Premium Plan</h3>
              <div class="price mb-3"><sup class="currency">RM</sup><span class="number">99.99</span> <span class="per">/year</span></div>
              <p class="text-muted mb-4">* Billed annualy or RM10 per month</p>
              <ul class="list-unstyled ul-check text-left success mb-5">
              ...
              <p><a href="plan.php" class="btn btn-lg btn-secondary rounded-0 btn-block">Choose your plan</a></p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="mb-5">Any Question Requiry or Suggestion, please feel free to fill the form</p>
          </div>
        </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span>21-03-03 Rista Villa Pangsapuri, Taman Putra Perdana, Puchong</span>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-4">
              <span class="icon-phone d-block h2 text-primary"></span>
              <a href="#">+60172603472</a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-0">
              <span class="icon-mail_outline d-block h2 text-primary"></span>
              <a href="#">wufo@wufo.com</a>
            </p>
          </div>
        </div>
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3 ml-auto">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="http://localhost/stock/lumino/login.php" class="smoothscroll">Admin Login</a></li>
                </ul>
              </div>
              <div class="col-md-3 footer-social">
                <h2 class="footer-heading mb-4">Follow Us</h2>
                <a href="https://www.facebook.com/chikitennysonn/" class="pl-0 pr-3"><span class="icon-facebook"></span></a>
          ...
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p class="copyright"><small>
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Officially Website by <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Fahmi Ridwan</a>
